<x-layout>
    ...
    <section class="px-6 py-8">
        <main class="max-w-lg mx-auto mt-10 bg-gray-100 border border-gray-200 p-6 rounded-xl">
            <h1 class="text-center front-bold text-xl">Registra t</h1>
            <form method="POST" action="/registre" class="mt-10">
                @csrf
                <div class="mb-6">
                    <label class="block mb-2 uppercase front-bold text-xs text-gray-700" for="username">
                        Nom usuari
                    </label>
                    <input class="border border-gray-400 p-2 w-full" type="text" name="username" id="username" required>
                </div>
                <div class="mb-6">
                    <label class="block mb-2 uppercase front-bold text-xs text-gray-700" for="name">
                        Nom
                    </label>
